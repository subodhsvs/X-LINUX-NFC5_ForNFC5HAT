 ...
 *
 * This method implements the main state machine going through all the
...
extern void exampleRfalPollerRun(void)
{
    ...
    {
        /* in case the rfal initalization failed signal it by displaying text
           on the screen */
        while(1)
        {
            platformLogClear();
            ...
            platformLog2Screen(logBuffer);                                            /* print to terminal screen */
            platformDelay(100);
        }
    }
